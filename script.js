/* nesse codigos estamos armazenando 
variaveis que foram declarados no html para pode utilizar elas depois no css e aqui no javascript*/
...
const trafficLight = (event) => {
    stopAutomatic();
    turnOn[event.target.id](); //aqui ele irá ler qual luz de semáforo que será acessa
}
