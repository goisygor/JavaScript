    ...
    <div id="clima" :class="typeof weather.main != 'undefined' && weather.main.temp > 22 ? 'warm' : ''">
        ...
        <main>
            ...
            <div class="weather-wrap" v-if="typeof weather.main != 'undefined'">
                ...
                <!-- Caixa de informações sobre o clima, exibindo temperatura e condição
...
export default {
    ...
    name: 'app',
    // Dados do componente, incluindo chave de API, URL base, consulta de pesquisa, e Faz pesquisa de dados meteorológicos
    data() {
        return {
